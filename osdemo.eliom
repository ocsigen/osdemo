...
let%shared () =
  ...
  Eliom_registration.Action.register
    ...
    Osdemo_handlers.set_personal_data_handler;

  Eliom_registration.Redirection.register
    ~service:Os_services.set_password_service
    Osdemo_handlers.set_password_handler;

  Eliom_registration.Action.register
    ~service:Os_services.forgot_password_service
    Osdemo_handlers.forgot_password_handler;

  Eliom_registration.Action.register
    ~service:Os_services.preregister_service
    Osdemo_handlers.preregister_handler;
  ...
  Eliom_registration.Any.register
    ...
    (Os_session.Opt.connected_fun
       Osdemo_handlers.action_link_handler);
  ...
  Eliom_registration.Action.register
    ...
    Osdemo_handlers.update_language_handler;

  Osdemo_base.App.register
    ~service:Os_services.main_service
    (Osdemo_page.Opt.connected_page Osdemo_handlers.main_service_handler);

  Osdemo_base.App.register
    ~service:Osdemo_services.about_service
    (Osdemo_page.Opt.connected_page Osdemo_handlers.about_handler);

  Osdemo_base.App.register
    ~service:Osdemo_services.settings_service
    (Osdemo_page.Opt.connected_page Osdemo_handlers.settings_handler)

let%server () =
  Eliom_registration.Ocaml.register
    ~service:Osdemo_services.upload_user_avatar_service
    (Os_session.connected_fun Osdemo_handlers.upload_user_avatar_handler)


(* Print more debugging information when <debugmode/> is in config file
   (DEBUG = yes in Makefile.options).
   Example of use:
   let section = Lwt_log.Section.make "Osdemo:sectionname"
   ...
  ...
  then begin
    ignore
      [%client (
        ...
        Lwt_log_core.add_rule "Osdemo*" Lwt_log.Debug
